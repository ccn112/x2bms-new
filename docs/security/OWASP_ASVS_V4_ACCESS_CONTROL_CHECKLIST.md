...
| **4.2.1** | Chống **IDOR** — tham chiếu đối tượng trực tiếp được kiểm quyền | Đã audit BOLA/IDOR **API cư dân** (29 controller, 2026-08-04): sửa poll-vote + @mention xuyên tenant; tiền/thông báo scope đúng. **CÒN** API panel BQL/HQ/SA + over-exposure | `DATA_LEAK_AUDIT_20260804.md`, `CommunityPollScopeTest`, `CommunityCommentMentionTest`, `TenantCompositeFkTest` | 🟡 |
